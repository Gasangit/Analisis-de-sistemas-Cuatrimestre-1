...
class Craps {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "Tendrá 3 dados para jugar:\n"
		...
		JOptionPane.showMessageDialog(null, "Usted apostará $" + apuesta);
			...
			if (suma==6||suma==9||suma==12) {
				...
				if (dado1==dado2 && dado1==dado3) {
					...
					if (dado1==1 || dado2==1|| dado3==1) {
						gana = apuesta + 10;
						JOptionPane.showMessageDialog(null, "Saco al menos un 1. Gana su apuesta $" + apuesta + " más $10. Es decir $" + gana 
												   					   + "\nDado 1: " + dado1 + "\nDado 2: " + dado2 + "\nDado 3: " + dado3);
					} else {
